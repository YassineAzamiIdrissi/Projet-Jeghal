...
public class ClientHistoriqueController {
    ...
    public void initialize() throws RemoteException {
        ...
        ObservableList<Reservation> chambreLignes = FXCollections.observableArrayList(fetchClientHistorique());
    ...
    List<Reservation> fetchClientHistorique() throws RemoteException {
        return client.getHistReservations(SessionManager.getSession().getId());
    }
